...
abstract class $AdminCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String description, String tagline});
}
...
class _$AdminImpl implements _Admin {
  ...
  @override
  String toString() {
    return 'Admin(id: $id, name: $name, description: $description, tagline: $tagline)';
  }
...
abstract class _Admin implements Admin {
  const factory _Admin(
      ...
      required final String tagline}) = _$AdminImpl;
